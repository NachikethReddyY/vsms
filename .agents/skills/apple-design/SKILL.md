---
name: apple-design
description: Create a more professional looking design like how Apple created their interfaces. To make it more fluid, responsive, and natural. Use when the user asks to improve the design of a web application or website.
---
