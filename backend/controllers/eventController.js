...
exports.createStationTemplate = async (req, res) => res.status(201).json(await eventService.createStationTemplate(req.body));
exports.updateStationTemplate = async (req, res) => res.json(await eventService.updateStationTemplate(req.params.stationTemplateId, req.body));
