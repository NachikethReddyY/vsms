...
const assertKit = (kit) => {
  ...
  for (const required of ["managed-auth-session", "event-duty-boundary", "account-lifecycle-boundary", "registration-consent-qr-checkin", "queue-transfer-and-four-stations", "eye-health-fourth-station", "review-referral", "offline-reconnect", "dashboard-and-export"]) {
