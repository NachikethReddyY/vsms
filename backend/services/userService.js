...
const projectUser = ({ userRoles, sysRole, ...user }) => ({
  ...user,
  systemRole: sysRole,
...
exports.createUser = async (userData, actorId, context) => prisma.$transaction(async (tx) => {
...
exports.updateUser = async (userId, userData, actorId, context) => prisma.$transaction(async (tx) => {
