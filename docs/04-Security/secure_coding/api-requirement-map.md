...
| FR-05 Screening results and flags | `listScreeningStations`, `listScreeningQueue`, `resolveScreeningParticipant`, `previewVisualAcuity`, `saveVisualAcuity`, `previewRefraction`, `saveRefraction`, `previewColourVision`, `saveColourVision`, `previewEyeHealth`, `saveEyeHealth` | [`screeningRoutes.js`](../../backend/routes/screeningRoutes.js), [`screeningController.js`](../../backend/controllers/screeningController.js), [`screeningService.js`](../../backend/services/screening/screeningService.js) | Implemented for all four station types |
...
| NFR-OFFLINE | `syncScreeningBatch` at `POST /api/v1/events/{eventId}/sync/screening` | [`SynchronizationRoutes.js`](../../backend/routes/SynchronizationRoutes.js), [`syncService.js`](../../backend/services/screening/syncService.js), [`offlineSync.ts`](../../react-user-dashboard/src/features/screening/offlineSync.ts) | Implemented for scoped VA/refraction/colour-vision/eye-health flow |
