    ...
    <div className={`app-shell ${collapsed ? 'rail' : ''}`} data-astryx-theme="neutral">
      ...
      <div className="app-main">
        <header className="command-bar">
          ...
          <ThemeToggle />
          {location.pathname !== '/events/new' && user?.systemRole !== 'STAFF' && <button className="primary compact" onClick={() => navigate('/events/new')} aria-label="Create event"><PlusIcon /><span>New event</span></button>}
        </header>
