...
export type DeletionPreview = { previewToken: string; previewExpiresAt?: string; blockers: Array<string | { code: string; message: string; count?: number }>; version?: number; eventId?: string; eventName?: string; status?: string; counts?: Record<string, number>; event?: { name?: string; version?: number }; impactDigest?: string };
